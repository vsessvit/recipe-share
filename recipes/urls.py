...
urlpatterns = [
    ...
    path('recipe/<slug:slug>/edit/', views.RecipeUpdateView.as_view(), name='recipe_update'),
    ...
    path('cuisine/<slug:slug>/', views.CountryRecipeListView.as_view(), name='country_recipes'),
